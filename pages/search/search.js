...
Page({
    ...
    hideHistoryTap: function() {
        this.setData({
            isHistoryShow: !this.data.isHistoryShow
        });
    },
    ...
    searchTap: function() {
        ...
        wx.request({
            ...
            data: {
                catid: _this.data.search.catid,
                keyword: _this.data.search.text,
                sort: _this.data.search.sort
            },
            success: function(res) {
                ...
                _this.setData({
                    searchResults: _this.data.searchResults
                });
            },
            complete: function() {
                wx.hideLoading();
