...
Page({
  ...
  getNotice: function (data) {
    ...
    wx.request({
      ...
      data: {id: data.id, catid: data.catid},
      success: function(res) {
        var r = res.data;
        if(r && r.result == 1) {
          var notice = r.data;
          _this.data.notice = { id: notice.id, title: notice.title, content: notice.content, 
            publisher: notice.publisher, publishdate: notice.publishdate};

          _this.setData({ notice: _this.data.notice});
        }
      }
    })
  },
